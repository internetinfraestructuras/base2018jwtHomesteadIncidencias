	...
	{	
		...
		{	
				...
				{		
					...
					$sel ="select background_id,flagbackgroundact from clientes_iptvs
							where
					...
					{
						$idbackground=$row["background_id"];
						$actualizado=$row["flagbackgroundact"];
					}
					
					//si esta marcado para actualizar, devuelvo el listado de canales
					if($actualizado==1)
					{
						$sel2 ="select urlbackground from backgrounds 
								where
								id=$idbackground";
						...
						$sel3 ="update clientes_iptvs set flagbackgroundact=0
