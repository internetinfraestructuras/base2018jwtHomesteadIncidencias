...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('servicio')}}" method="post" novalidate>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="servicio">Servicio</label>
                        <div class="col-sm-5">
                            <input id="servicio" class="form-control" type="servicio" placeholder="Servicio" name="servicio" value="{{ old('servicio') }}">
                        </div>
